...
namespace VarinaCmsV2.Security
{
    public static class CustomSecurityStampValidator
    {
        ...
        public static Func<CookieValidateIdentityContext, Task> OnValidateIdentity(
            TimeSpan validateInterval, Func<AppUserManager, User, Task<ClaimsIdentity>> regenerateIdentity)
        {
        ...
        /// <returns></returns>
        public static Func<CookieValidateIdentityContext, Task> OnValidateIdentity(
            TimeSpan validateInterval, Func<AppUserManager, User, Task<ClaimsIdentity>> regenerateIdentityCallback,
