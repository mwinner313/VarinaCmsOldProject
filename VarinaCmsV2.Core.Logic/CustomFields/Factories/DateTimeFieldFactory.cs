...
{
    public class DateTimeFieldFactory:CustomFieldFactory<JObject>
    {
        public DateTimeFieldFactory() : base("datetime")
        {
        }

        public override bool IsValidForField(object data, JObject fdMetaData = null)
        {
            return (data is string str) && Regex.IsMatch(str, RegexPattern.DateTime);
        }
        ...
        public override bool IsValidForField(JObject data, JObject metaData )
        {
            ...
            return Regex.IsMatch(datetimefield.DateTimeString, RegexPattern.DateTime);
        }
        ...
        public override CustomField<JObject> LoadField(JObject data, string fieldName, JObject metaData)
        {
            ...
            return new DateTimeField(this, fieldName, data);
        }
    }
}
